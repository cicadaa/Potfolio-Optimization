...
MODEL CVaRModel 'The Conditional Value-at-Risk Model' /BudgetCon,  LossDefCon,ReturnLimCon, VaRDevCon,CVaRDefCon, ObjectivFunc, CVaRLimCon, 
...
*and ord(p)<6),   
    ...
    CVaRMAX(p) = CVaR.l;
    DISPLAY sell.l,buy.l,x.l,CVaRLim;
    );
